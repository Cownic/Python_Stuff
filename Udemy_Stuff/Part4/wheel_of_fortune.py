...
class WOFHumanPlayer(WOFPlayer):
    def getMove(self, category, obscured_phrase, guessed):
        showBoard(category, obscured_phrase, guessed)
        choice = input('Guess a letter, phrase, or type exit or pass:')
        return choice
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def __init__(self, name_x, difficulty_x):
        WOFPlayer.__init__(self, name_x)
        self.difficulty = difficulty_x
